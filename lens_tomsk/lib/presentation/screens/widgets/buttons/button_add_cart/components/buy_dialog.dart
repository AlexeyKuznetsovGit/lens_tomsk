...
void showBuyDialog(BuildContext context, Product product) => showDialog(
      ...
      builder: (_) => Dialog(
        insetPadding: EdgeInsets.only(right: 10.w,  left: 10.w, ),
...
decoration: BoxDecoration(
                  ...
                  child: Center(child: Text("Добавить товар в корзину", style: TextStyle(
                                color: kWhiteColor,
                                fontFamily: 'OpenSans-Regular',
                                fontSize: 12.sp,
                                fontWeight: FontWeight.w600),)),
                ),
                onTap: () => {BlocProvider.of<ButtonAddCartCubit>(context)
                    .addToCart(product),
