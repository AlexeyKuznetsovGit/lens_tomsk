...
import 'package:lens_tomsk/presentation/screens/details_product/components/details_button_cart/details_button_cart.dart';
import 'package:lens_tomsk/presentation/screens/widgets/buttons/button_add_cart/cubit/button_add_cart_cubit.dart';

class DetailsButtonCartProvider extends StatelessWidget {
  const DetailsButtonCartProvider({
    Key? key,
  ...
  Widget build(BuildContext context) {
    return BlocProvider<ButtonAddCartCubit>(
      ...
      child: DetailsButtonCart(product: product),
    );
  }
}